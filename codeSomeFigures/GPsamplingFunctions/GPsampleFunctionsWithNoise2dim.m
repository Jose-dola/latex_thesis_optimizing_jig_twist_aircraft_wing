...
%  for l = larray
    getGaussianPriorAndPosteriorSamples2dim(f,xtraining,n,xtest,nt,ytraining,1,3,1,l,sdnoise);
    getGaussianPosteriorLotsOfSamples2dim(f,xtraining,n,xtest,nt,ytraining,1,l,sdnoise);
%  end
%end 
